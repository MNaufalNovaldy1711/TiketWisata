...
if(isset($_POST['submit'])){
    ...
    $q="SELECT * FROM tbl_pengguna WHERE username='$name' AND password='$password'";
    ...
    if ($row['username'] == $name AND $row['password'] == $password) {
        ...
        echo "Username atau Password Anda Salah"; // jika gagal, maka muncul teks gagal masuk
    }
}
...
<html>
<head>
    <title>Login User | Remen Beach</title>
...
<h2 style="color: #ffcc00; font-family: align; font-size: 30px; margin-top: 70px; margin-bottom: 40px;">LOGIN USER</h2>
<p style="color: #fff; ">Masukan data dibawah ini</p>
    ...
    <div class="content-isi">
        ...
        <tr>
            ...
            <td>:<td><input style="height:20px;" class="tb2" type="text" name="username"  placeholder="Masukan Username" / required autocomplete=""></td></tr>
        <br>    
        <tr>
